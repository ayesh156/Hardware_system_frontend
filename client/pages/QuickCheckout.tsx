...
import {
  ...
  ArrowRight, ArrowUp, ArrowDown, ArrowLeftIcon
} from 'lucide-react';
...
export const QuickCheckout: React.FC = () => {
  ...
  }, [items, productSearch, filteredProducts, selectedProductIndex, selectedCartIndex, isCartFocused, isPaymentFocused, isQuantityFocused, pendingProduct, showShortcuts, handleCheckout, removeItem, addProductToCart, updateItemQuantity, playBeep]);
        ...
        <div className="flex items-center justify-between max-w-7xl mx-auto">
          ...
          <div className="flex items-center gap-2">
            ...
            <button
              ...
              className={`p-2 rounded-lg transition-colors ${isDark ? 'hover:bg-slate-700' : 'hover:bg-slate-100'} ${showShortcuts ? 'text-blue-500' : isDark ? 'text-slate-400' : 'text-slate-600'}`}
