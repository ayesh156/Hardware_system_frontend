...
export const mockProducts: Product[] = [
  ...
  // Steel Products
  {
    ...
    hasVariants: true,
    variants: [
      { id: 'var-003-1', productId: 'prod-003', size: '8mm', sku: 'STL-LANWA-8MM', barcode: '8901234567003001', costPrice: 270, wholesalePrice: 300, retailPrice: 340, stock: 150, minStock: 30, isActive: true },
      { id: 'var-003-2', productId: 'prod-003', size: '10mm', sku: 'STL-LANWA-10MM', barcode: '8901234567003002', costPrice: 280, wholesalePrice: 310, retailPrice: 350, stock: 200, minStock: 40, isActive: true },
      { id: 'var-003-3', productId: 'prod-003', size: '12mm', sku: 'STL-LANWA-12MM', barcode: '8901234567003003', costPrice: 285, wholesalePrice: 315, retailPrice: 360, stock: 100, minStock: 30, isActive: true },
      { id: 'var-003-4', productId: 'prod-003', size: '16mm', sku: 'STL-LANWA-16MM', barcode: '8901234567003004', costPrice: 290, wholesalePrice: 320, retailPrice: 365, stock: 50, minStock: 20, isActive: true },
    ],
  ...
  },
  {
    ...
    hasVariants: true,
    variants: [
      { id: 'var-004-1', productId: 'prod-004', size: '1/2"', sku: 'PIPE-MELWA-GI-0.5', barcode: '8901234567004001', costPrice: 650, wholesalePrice: 720, retailPrice: 850, stock: 30, minStock: 10, isActive: true },
      { id: 'var-004-2', productId: 'prod-004', size: '3/4"', sku: 'PIPE-MELWA-GI-0.75', barcode: '8901234567004002', costPrice: 750, wholesalePrice: 830, retailPrice: 950, stock: 25, minStock: 10, isActive: true },
      { id: 'var-004-3', productId: 'prod-004', size: '1"', sku: 'PIPE-MELWA-GI-1', barcode: '8901234567004003', costPrice: 850, wholesalePrice: 950, retailPrice: 1100, stock: 35, minStock: 10, isActive: true },
      { id: 'var-004-4', productId: 'prod-004', size: '1 1/2"', sku: 'PIPE-MELWA-GI-1.5', barcode: '8901234567004004', costPrice: 1200, wholesalePrice: 1350, retailPrice: 1550, stock: 20, minStock: 5, isActive: true },
      { id: 'var-004-5', productId: 'prod-004', size: '2"', sku: 'PIPE-MELWA-GI-2', barcode: '8901234567004005', costPrice: 1600, wholesalePrice: 1800, retailPrice: 2100, stock: 10, minStock: 5, isActive: true },
    ],
  ...
  // Electrical Products
  {
    ...
    hasVariants: true,
    variants: [
      { id: 'var-005-1', productId: 'prod-005', size: '1.0mm²', color: 'Red', sku: 'ELC-KELANI-1.0-R', barcode: '8901234567005001', costPrice: 65, wholesalePrice: 72, retailPrice: 85, stock: 500, minStock: 100, isActive: true },
      { id: 'var-005-2', productId: 'prod-005', size: '1.5mm²', color: 'Red', sku: 'ELC-KELANI-1.5-R', barcode: '8901234567005002', costPrice: 85, wholesalePrice: 95, retailPrice: 110, stock: 600, minStock: 150, isActive: true },
      { id: 'var-005-3', productId: 'prod-005', size: '2.5mm²', color: 'Red', sku: 'ELC-KELANI-2.5-R', barcode: '8901234567005003', costPrice: 135, wholesalePrice: 150, retailPrice: 175, stock: 400, minStock: 100, isActive: true },
      { id: 'var-005-4', productId: 'prod-005', size: '4.0mm²', color: 'Red', sku: 'ELC-KELANI-4.0-R', barcode: '8901234567005004', costPrice: 210, wholesalePrice: 235, retailPrice: 275, stock: 300, minStock: 80, isActive: true },
      { id: 'var-005-5', productId: 'prod-005', size: '6.0mm²', color: 'Red', sku: 'ELC-KELANI-6.0-R', barcode: '8901234567005005', costPrice: 320, wholesalePrice: 355, retailPrice: 420, stock: 200, minStock: 50, isActive: true },
    ],
  ...
  },
  {
    ...
    hasVariants: true,
    variants: [
      { id: 'var-006-1', productId: 'prod-006', color: 'White', sku: 'ELC-ORANGE-SW1-W', barcode: '8901234567006001', costPrice: 120, wholesalePrice: 145, retailPrice: 185, stock: 200, minStock: 30, isActive: true },
      { id: 'var-006-2', productId: 'prod-006', color: 'Black', sku: 'ELC-ORANGE-SW1-B', barcode: '8901234567006002', costPrice: 130, wholesalePrice: 155, retailPrice: 195, stock: 100, minStock: 20, isActive: true },
      { id: 'var-006-3', productId: 'prod-006', color: 'Grey', sku: 'ELC-ORANGE-SW1-G', barcode: '8901234567006003', costPrice: 130, wholesalePrice: 155, retailPrice: 195, stock: 50, minStock: 15, isActive: true },
    ],
  ...
  },
  {
    ...
    hasVariants: true,
    variants: [
      { id: 'var-007-1', productId: 'prod-007', size: '6A', sku: 'ELC-ACL-MCB-6A', barcode: '8901234567007001', costPrice: 350, wholesalePrice: 390, retailPrice: 460, stock: 25, minStock: 5, isActive: true },
      { id: 'var-007-2', productId: 'prod-007', size: '16A', sku: 'ELC-ACL-MCB-16A', barcode: '8901234567007002', costPrice: 380, wholesalePrice: 420, retailPrice: 495, stock: 40, minStock: 10, isActive: true },
      { id: 'var-007-3', productId: 'prod-007', size: '32A', sku: 'ELC-ACL-MCB-32A', barcode: '8901234567007003', costPrice: 420, wholesalePrice: 465, retailPrice: 550, stock: 35, minStock: 8, isActive: true },
      { id: 'var-007-4', productId: 'prod-007', size: '63A', sku: 'ELC-ACL-MCB-63A', barcode: '8901234567007004', costPrice: 580, wholesalePrice: 640, retailPrice: 750, stock: 20, minStock: 5, isActive: true },
    ],
  ...
  // Plumbing Products
  {
    ...
    hasVariants: true,
    variants: [
      { id: 'var-008-1', productId: 'prod-008', size: '1/2"', sku: 'PLB-NAT-PVC-0.5', barcode: '8901234567008001', costPrice: 280, wholesalePrice: 320, retailPrice: 380, stock: 50, minStock: 15, isActive: true },
      { id: 'var-008-2', productId: 'prod-008', size: '3/4"', sku: 'PLB-NAT-PVC-0.75', barcode: '8901234567008002', costPrice: 350, wholesalePrice: 400, retailPrice: 480, stock: 45, minStock: 12, isActive: true },
      { id: 'var-008-3', productId: 'prod-008', size: '1"', sku: 'PLB-NAT-PVC-1', barcode: '8901234567008003', costPrice: 450, wholesalePrice: 520, retailPrice: 620, stock: 40, minStock: 10, isActive: true },
      { id: 'var-008-4', productId: 'prod-008', size: '2"', sku: 'PLB-NAT-PVC-2', barcode: '8901234567008004', costPrice: 750, wholesalePrice: 850, retailPrice: 1000, stock: 35, minStock: 8, isActive: true },
      { id: 'var-008-5', productId: 'prod-008', size: '4"', sku: 'PLB-NAT-PVC-4', barcode: '8901234567008005', costPrice: 1400, wholesalePrice: 1600, retailPrice: 1900, stock: 30, minStock: 5, isActive: true },
    ],
  ...
  // Paint Products
  {
    ...
    hasVariants: true,
    variants: [
      { id: 'var-009-1', productId: 'prod-009', size: '1L', color: 'White', sku: 'PNT-NIP-WB-1L-W', barcode: '8901234567009001', costPrice: 850, wholesalePrice: 950, retailPrice: 1100, stock: 20, minStock: 5, isActive: true },
      { id: 'var-009-2', productId: 'prod-009', size: '4L', color: 'White', sku: 'PNT-NIP-WB-4L-W', barcode: '8901234567009002', costPrice: 2800, wholesalePrice: 3100, retailPrice: 3600, stock: 25, minStock: 5, isActive: true },
      { id: 'var-009-3', productId: 'prod-009', size: '10L', color: 'White', sku: 'PNT-NIP-WB-10L-W', barcode: '8901234567009003', costPrice: 4200, wholesalePrice: 4600, retailPrice: 5200, stock: 20, minStock: 3, isActive: true },
      { id: 'var-009-4', productId: 'prod-009', size: '20L', color: 'White', sku: 'PNT-NIP-WB-20L-W', barcode: '8901234567009004', costPrice: 7800, wholesalePrice: 8500, retailPrice: 9500, stock: 20, minStock: 3, isActive: true },
    ],
  ...
  },
  {
    ...
    hasVariants: true,
    variants: [
      { id: 'var-010-1', productId: 'prod-010', size: '500ml', color: 'White', sku: 'PNT-DUL-SGE-500-W', barcode: '8901234567010001', costPrice: 750, wholesalePrice: 850, retailPrice: 1000, stock: 15, minStock: 3, isActive: true },
      { id: 'var-010-2', productId: 'prod-010', size: '1L', color: 'White', sku: 'PNT-DUL-SGE-1L-W', barcode: '8901234567010002', costPrice: 1350, wholesalePrice: 1500, retailPrice: 1750, stock: 20, minStock: 5, isActive: true },
      { id: 'var-010-3', productId: 'prod-010', size: '4L', color: 'White', sku: 'PNT-DUL-SGE-4L-W', barcode: '8901234567010003', costPrice: 4800, wholesalePrice: 5300, retailPrice: 6200, stock: 15, minStock: 3, isActive: true },
    ],
  ...
  },
  {
    ...
    hasVariants: true,
    variants: [
      { id: 'var-012-1', productId: 'prod-012', size: '5m', sku: 'TLS-STAN-TAPE-5M', barcode: '8901234567012001', costPrice: 1500, wholesalePrice: 1700, retailPrice: 2000, stock: 20, minStock: 5, isActive: true },
      { id: 'var-012-2', productId: 'prod-012', size: '8m', sku: 'TLS-STAN-TAPE-8M', barcode: '8901234567012002', costPrice: 1800, wholesalePrice: 2000, retailPrice: 2400, stock: 15, minStock: 3, isActive: true },
      { id: 'var-012-3', productId: 'prod-012', size: '10m', sku: 'TLS-STAN-TAPE-10M', barcode: '8901234567012003', costPrice: 2200, wholesalePrice: 2450, retailPrice: 2900, stock: 10, minStock: 3, isActive: true },
    ],
  ...
  // Hardware - Nails, Screws, etc.
  {
    ...
    hasVariants: true,
    variants: [
      { id: 'var-013-1', productId: 'prod-013', size: '1"', sku: 'HW-NAILS-1IN', barcode: '8901234567013001', costPrice: 200, wholesalePrice: 230, retailPrice: 280, stock: 80, minStock: 20, isActive: true },
      { id: 'var-013-2', productId: 'prod-013', size: '2"', sku: 'HW-NAILS-2IN', barcode: '8901234567013002', costPrice: 190, wholesalePrice: 220, retailPrice: 270, stock: 120, minStock: 25, isActive: true },
      { id: 'var-013-3', productId: 'prod-013', size: '3"', sku: 'HW-NAILS-3IN', barcode: '8901234567013003', costPrice: 180, wholesalePrice: 210, retailPrice: 260, stock: 150, minStock: 30, isActive: true },
      { id: 'var-013-4', productId: 'prod-013', size: '4"', sku: 'HW-NAILS-4IN', barcode: '8901234567013004', costPrice: 175, wholesalePrice: 205, retailPrice: 255, stock: 100, minStock: 20, isActive: true },
    ],
    countryOfOrigin: 'Sri Lanka',
    specifications: {
      'Material': 'Mild Steel',
  ...
  },
  {
    ...
    hasVariants: true,
    variants: [
      { id: 'var-014-1', productId: 'prod-014', size: '1" x 6', sku: 'HW-SCREW-1X6', barcode: '8901234567014001', costPrice: 280, wholesalePrice: 320, retailPrice: 380, stock: 60, minStock: 10, isActive: true },
      { id: 'var-014-2', productId: 'prod-014', size: '1.5" x 8', sku: 'HW-SCREW-1.5X8', barcode: '8901234567014002', costPrice: 320, wholesalePrice: 365, retailPrice: 430, stock: 80, minStock: 15, isActive: true },
      { id: 'var-014-3', productId: 'prod-014', size: '2" x 8', sku: 'HW-SCREW-2X8', barcode: '8901234567014003', costPrice: 350, wholesalePrice: 400, retailPrice: 480, stock: 90, minStock: 15, isActive: true },
      { id: 'var-014-4', productId: 'prod-014', size: '3" x 10', sku: 'HW-SCREW-3X10', barcode: '8901234567014004', costPrice: 450, wholesalePrice: 510, retailPrice: 600, stock: 70, minStock: 10, isActive: true },
    ],
    specifications: {
      'Head Type': 'Phillips',
  ...
  // Roofing
  {
    ...
    hasVariants: true,
    variants: [
      { id: 'var-015-1', productId: 'prod-015', size: '8ft', color: 'Tile Red', sku: 'ROOF-AMA-8-RED', barcode: '8901234567015001', costPrice: 650, wholesalePrice: 720, retailPrice: 850, stock: 40, minStock: 10, isActive: true },
      { id: 'var-015-2', productId: 'prod-015', size: '10ft', color: 'Tile Red', sku: 'ROOF-AMA-10-RED', barcode: '8901234567015002', costPrice: 850, wholesalePrice: 950, retailPrice: 1100, stock: 50, minStock: 12, isActive: true },
      { id: 'var-015-3', productId: 'prod-015', size: '12ft', color: 'Tile Red', sku: 'ROOF-AMA-12-RED', barcode: '8901234567015003', costPrice: 1050, wholesalePrice: 1150, retailPrice: 1350, stock: 35, minStock: 8, isActive: true },
      { id: 'var-015-4', productId: 'prod-015', size: '10ft', color: 'Dark Green', sku: 'ROOF-AMA-10-GRN', barcode: '8901234567015004', costPrice: 850, wholesalePrice: 950, retailPrice: 1100, stock: 25, minStock: 5, isActive: true },
    ],
  ...
  // Safety Equipment
  {
    ...
    hasVariants: true,
    variants: [
      { id: 'var-016-1', productId: 'prod-016', color: 'White', sku: 'SAF-HELMET-WHT', barcode: '8901234567016001', costPrice: 450, wholesalePrice: 520, retailPrice: 650, stock: 25, minStock: 5, isActive: true },
      { id: 'var-016-2', productId: 'prod-016', color: 'Yellow', sku: 'SAF-HELMET-YLW', barcode: '8901234567016002', costPrice: 450, wholesalePrice: 520, retailPrice: 650, stock: 30, minStock: 5, isActive: true },
      { id: 'var-016-3', productId: 'prod-016', color: 'Blue', sku: 'SAF-HELMET-BLU', barcode: '8901234567016003', costPrice: 450, wholesalePrice: 520, retailPrice: 650, stock: 15, minStock: 3, isActive: true },
      { id: 'var-016-4', productId: 'prod-016', color: 'Red', sku: 'SAF-HELMET-RED', barcode: '8901234567016004', costPrice: 450, wholesalePrice: 520, retailPrice: 650, stock: 10, minStock: 3, isActive: true },
    ],
    specifications: {
      'Material': 'HDPE',
      'Standard': 'EN 397',
  ...
  // Aggregates - Sand & Stones
  {
    ...
    hasVariants: true,
    variants: [
      { id: 'var-017-1', productId: 'prod-017', size: '0.5 Cube', sku: 'AGG-SAND-RIV-0.5', barcode: '8901234567017001', costPrice: 9500, wholesalePrice: 10500, retailPrice: 11500, stock: 20, minStock: 2, isActive: true },
      { id: 'var-017-2', productId: 'prod-017', size: '1 Cube', sku: 'AGG-SAND-RIV-1', barcode: '8901234567017002', costPrice: 18000, wholesalePrice: 20000, retailPrice: 22000, stock: 30, minStock: 3, isActive: true },
    ],
    countryOfOrigin: 'Sri Lanka',
  ...
  },
  {
    ...
    hasVariants: true,
    variants: [
      { id: 'var-018-1', productId: 'prod-018', size: '0.5 Cube', sku: 'AGG-MET-0.75-0.5', barcode: '8901234567018001', costPrice: 8500, wholesalePrice: 9000, retailPrice: 10000, stock: 15, minStock: 2, isActive: true },
      { id: 'var-018-2', productId: 'prod-018', size: '1 Cube', sku: 'AGG-MET-0.75-1', barcode: '8901234567018002', costPrice: 16000, wholesalePrice: 17500, retailPrice: 19000, stock: 25, minStock: 3, isActive: true },
    ],
    countryOfOrigin: 'Sri Lanka',
  ...
  },
  {
    ...
    hasVariants: true,
    variants: [
      { id: 'var-020-1', productId: 'prod-020', size: '4 inch', sku: 'BLK-CEM-4IN', barcode: '8901234567020001', costPrice: 65, wholesalePrice: 75, retailPrice: 90, stock: 1200, minStock: 300, isActive: true },
      { id: 'var-020-2', productId: 'prod-020', size: '6 inch', sku: 'BLK-CEM-6IN', barcode: '8901234567020002', costPrice: 85, wholesalePrice: 95, retailPrice: 115, stock: 800, minStock: 200, isActive: true },
    ],
    countryOfOrigin: 'Sri Lanka',
