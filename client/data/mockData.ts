import { Customer, Product, Invoice, Brand, Category, Supplier } from '../types/index';
...
export const mockSuppliers: Supplier[] = [
  {
    id: 'sup-001',
    name: 'Lanka Building Materials Pvt Ltd',
    contactPerson: 'Sunil Perera',
    email: 'sunil@lankabm.lk',
    phone: '+94 11 234 5678',
    address: '45 Baseline Road, Colombo 9',
    brands: ['INSEE', 'Tokyo Cement', 'Holcim'],
  ...
  {
    id: 'sup-002',
    name: 'Steel Masters Lanka',
    contactPerson: 'Chaminda Silva',
    email: 'chaminda@steelmasters.lk',
    phone: '+94 11 456 7890',
    address: '78 Industrial Zone, Colombo 15',
    brands: ['Lanwa', 'Melwa'],
  ...
  {
    id: 'sup-003',
    name: 'Electrical Wholesale Center',
    contactPerson: 'Nimal Jayawardena',
    email: 'nimal@ewc.lk',
    phone: '+94 11 567 8901',
    address: '23 Panchikawatte Road, Colombo 10',
    brands: ['Kelani Cables', 'ACL Cables', 'Orange Electric'],
